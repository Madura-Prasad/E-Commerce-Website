...
<body>
    ...
    <section id="hero">
        <h4>Welcome to</h4>
        <h1>Zara Wide</h1>
        <h2>Online Exclusive Collection</h2>
    ...
    <section id="banner" class="section-m1 reveal">
        <h4>Buy 3 and Get</h4>
        <h2>Up to <span>50% Off</span> - On Any Other Item </h2>
    ...
    <section id="product1" class="section-p1 reveal">
        ...
        <div class="pro-container">
            ...
            <?php
            $sql = "SELECT * FROM product LIMIT 8 OFFSET 8";
            $result = $conn->query($sql);
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    $id = $row['id'];
    ...
    <section id="banner3" class="reveal">
        <div class="banner-box ">
