...
<form method="POST">
    <div class="group">
        <input type="text" name="email2"><span class="highlight"></span><span class="bar"></span>
        <label>Email</label>
        <br>
        <?php
    ...
    <div class="group">
        <input type="text" name="password2"><span class="highlight"></span><span class="bar"></span>
    ...
    <button name="login" type="submit" class="button buttonBlue">Log In
